...
Scenario: Single Product Existence
  Given product exists with name: "Milk", special: "2.99", normal: "4.99", diff: "2.00"
  When I go to the home page
  Then product's name should be "Milk"
  And product's special should be "2.99"
  And product's normal should be "4.99"
  And product's diff should be "2.00"
...
Scenario: Multiple Products Existence
 ...
 Scenario: Diff and Discount Calculation
   ...
   When I go to the home page
   Then product's diff should be "2.00"
   And product's discount should be "40.08"
