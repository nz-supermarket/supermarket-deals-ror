...
RSpec.describe PeriodHelper, type: :helper do
  describe '#human_period' do
    ...
    it 'should return 1 month if given 2_419_200' do
      expect(human_period(2_419_200)).to eq('1 month')
    end

    it 'should return 2 months, 2 days if given 5_011_200' do
      expect(human_period(5_011_200)).to eq('2 months, 2 days')
    end

    it 'should return 1 year, 2 months, 1 week, 2 days if given 37_137_600' do
      expect(human_period(37_137_600)).to eq('1 year, 2 months, 1 week, 2 days')
    end
  end
end
